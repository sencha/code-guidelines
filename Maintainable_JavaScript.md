# 保守しやすいJavaScriptを書くこと

著書「*Facts and Fallacies of Software Engineering*」で、筆者のRobert Glassは、 ソフトウェアのライフサイクルの80パーセント近くを保守作業が占めることを説明しています。それは単にバグ修正だけではありません。ほとんどの場合において、「保守」とは既存のアプリケーションに新しい機能を加えることも意味しています。
